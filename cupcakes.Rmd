...
# Load data
rawCupcakes <- read_csv(
  file = "https://raw.github.com/tedtasman/STAT-461-Course-Project/refs/heads/main/cupcake_data.csv",
...
cupcakes$Brand <- as.factor(cupcakes$Brand)
